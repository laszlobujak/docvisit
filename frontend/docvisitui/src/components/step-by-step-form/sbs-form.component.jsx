...
class SbsForm extends Component {
  ...
  secondStep = () => {
    ...
    change_class_name(
      this.activeFormContainer.current,
      'activ-form-container',
      'activ-form-container-second'
    );
    change_class_name(
      document.getElementsByClassName('dot')[1],
      'inactive-dots',
      'active'
    );
  ...
  thirdStep = () => {
    ...
    change_class_name(
      document.getElementsByClassName('activ-form-container-second')[0],
      'activ-form-container-second',
      'activ-form-container-third'
    );
    change_class_name(
      document.getElementsByClassName('dot')[2],
      'inactive-dots',
      'active'
    );
  ...
  saveAppointment = () => {
    ...
    axios
      .post('https://docvisit-proj.herokuapp.com/appointments', {
        headers: {
      ...
      <div className="sbs-form-container">
        ...
        <div className="form">
          ...
          <div className="activ-form-container" ref={this.activeFormContainer}>
            ...
            <div
              className="second-block-of-infos hidden"
              ref={this.secondBlockOfInfos}
            >
              <h6>When:</h6>
              <div id="datetime">
                <button
                  className="grid-date-item"
                  onClick={this.setTimeforVisit}
                >
                  9:00-10:00
                </button>
                <button
            ...
            <div
              className="third-block-of-infos hidden"
              ref={this.thirdBlockOfInfos}
            >
              <form>
                <h6>Your symptoms:</h6>
                <div className="form-group">
                  ...
                  <input
                    ...
                    id="symptoms"
                    aria-describedby="symptomsHelp"
                    onChange={this.giveSymptoms}
                  ></input>
                  <small id="symptomsHelp" className="form-text text-muted">
                    It isn't required, just optional
                  </small>
                  <button id="write-out" onClick={this.writeOut}>
                    + Add
                  </button>
                </div>
              </form>
